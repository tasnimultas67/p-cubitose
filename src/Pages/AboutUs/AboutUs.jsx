                ...
                <div className="w-11/12 m-auto">
                    <div>
                        <motion.h1
                            ...
                            viewport={{ once: true }}
                            className="text-grayColor text-3xl lg:text-5xl 2xl:text-7xl 2xl:leading-tight lg:leading-tight ">We are the <span className="text-black ">first call</span> for every outrageous, unthinkable and unknown <span className="text-black">possibility</span> in the field of digitally immersive experiences — <span className="text-black">all with highly competitive rates.</span></motion.h1>
                    </div>
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="mt-20">
                        <img className="rounded-xl shadow-lg h-[20rem] lg:h-[30rem] 2xl:h-[40rem] w-full object-cover object-center" src="https://images.unsplash.com/photo-1701003798116-b891466edf27?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="About Us Banner" srcSet="" />
                    </motion.div>
                    <OurTeam></OurTeam>
                </div>
            </div>  
