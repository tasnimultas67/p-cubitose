                ...
                <form onSubmit={handleSubmitTeam} className="space-y-3">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 items-center">
                        <div className="col-span-2 space-y-10 ">
                            <h2 className="text-center bg-themeColor w-fit px-5 py-2 m-auto rounded-md text-white 2xl:text-lg font-semibold">Preview Team Card</h2>
                            {/* Preview Team */}
                            <div className="w-7/12 m-auto">
                                <div className="relative overflow-hidden rounded-lg shadow w-full group/team">
                                    <img alt="Portfolio Cover Image" src={team?.teamImg ? team?.teamImg : 'https://images.unsplash.com/photo-1703817844004-0d0d4fc5abe4?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'} className="absolute w-full object-cover h-full group-hover/team:scale-125 duration-300 ease-in-out" loading="lazy" />
