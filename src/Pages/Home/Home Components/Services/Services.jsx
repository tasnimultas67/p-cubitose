        ...
        <>
            <div className="bg-white py-28">
                <div className="w-11/12 m-auto">
                    <div>
                        <h1 className="text-6xl text-black font-semibold text-center">So what do we do exactly?</h1>
                    </div>
                    {/* Service Cards */}
                    <div className="mt-20 grid grid-cols-3 gap-5">
                        {
                            services.map(service => <div key={service.id} className='relative overflow-hidden w-full h-[30rem] rounded-md bg-white bg-clip-border group/p1 cursor-pointer'>
