            ...
            <div className="w-10/12 lg:w-11/12 m-auto mb-20">
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-10">
                    ...
                    <div>
                        ...
                        <p className=" text-white mb-4 2xl:text-lg">We turn ideas into extraordinary digital products & experiences</p>
                        <Link className="text-white flex items-center gap-2 2xl:text-lg" to="mailto:info.cubitose@gmail.com"><EnvelopeIcon className="h-5 w-5"></EnvelopeIcon>info.cubitose@gmail.com</Link>
                    </div>
                    {/* Second Column */}
                    <div>
                        <ul className="page-list">
                            {
                                pages.map(page => <li
                                    key={page._id}
                                    className=" text-white 2xl:text-lg"><Link className="hover:underline 2xl:text-lg" to={page.pageUrl}>{page.pageTitle}</Link></li>)
                            }
                        ...
                        <ul className="uppercase text-white page-list">
                            {
                                servicesPages.map(servicePage => <li
                                    key={servicePage._id}
                                    className=" text-white"><Link className="hover:underline 2xl:text-lg" to={servicePage.pageUrl}>{ servicePage.pageTitle}</Link></li>)
                            }
