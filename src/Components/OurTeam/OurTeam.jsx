                    ...
                    teams.map(team => <div key={team.id}>
                        <div className="group/team overflow-hidden">
                            ...
                            <div className="flex gap-4 mt-3">
                                {/* Facebook */}
                                <Link to={`https://www.facebook.com/${team.facebook}`} target="_blank">
                                ...
                                {/* Instagram */}
                                <Link to={`https://www.instagram.com/${team.instagram}`} target="_blank">
                                ...
                                {/* Twitter */}
                                <Link to={`https://twitter.com/${team.twitter}`} target="_blank">
                                ...
                                {/* Personal Website */}
                                {
                                    team?.website.length>5 ? <Link to={team.website} target="_blank">
