    ...
    return (
        <div className='bg-white py-20'>
            <div className='w-11/12 m-auto'>
                <h1 className='text-center text-5xl font-semibold text-black'>Thoughts from our clients</h1>
                <div className='mt-10'>
                    <Swiper
                        modules={[Autoplay,]}
                        autoplay={{
                    ...
                    {reviews.map(review => <SwiperSlide key={review._id}>
                        ...
                        <figure className="max-w-screen-md mx-auto text-center">
                            ...
                            <blockquote>
                                <p className="text-xl italic text-gray-900 dark:text-white">&quot;{review.customerReview}&quot;</p>
                            </blockquote>
